...
function NapsatObsah(Hloubka, Menu, PodMenu, Lomitko) {
  ...
  document.write("<table id='subMenu0' BORDER=0 ALIGN=LEFT style='position:absolute; left:0px;top: 0px;visibility:hidden;z-index: 1;'>");
  document.write("<tr height=5><td NOWRAP></td></tr>");
  document.write("<tr><td>");
  document.write("<TABLE cellpadding='2' cellspacing='0' style='border: 1px solid #1871AD' bgcolor='#EEEAEE'>");
  document.write("<tr><td>");
